...
<?php
  include'header.php';
?>
<p style="padding: 16px; border: 16px solid red;left: 15%; right: 15%; font-size: 15px; text-align: justify;">
...
<br><br>
We all have got our report cards since school and college. Even in the corporate world, companies have an appraisal system to evaluate an employee. It’s high time that our elected representatives are evaluated and who better than us common citizens to do it!! So we present you with Corporators Report Card. I Think and I Vote. DO YOU?</p>
