...
echo "<div id='downloadList' class='row nav'>";
        echo "<a class='btn btn-primary' target='_self' rel='' href='uploads/Nagarsevak_Full_Data.zip' data-slimstat-clicked='false' data-slimstat-type='2' data-slimstat-tracking='false' data-slimstat-callback='false' data-slimstat-async='false'>All Prabhags</a>&nbsp";
