<!-- 
    File:           calculate_attendance_and_questions.php
    Date:           03-06-2016

    This script calculates the total questions and average attendance of nagarsevak and update the "nagarsevak" table.
 -->
<?php
