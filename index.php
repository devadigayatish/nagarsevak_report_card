...
<body>
<div id="space-for-margin" style="margin-top: 15px;"></div>
...
<div><select id="users" name="users" onchange="showUser(this.value)">
  
  <optgroup label='Aundh'><option value='6'>Prabhag 6: Bopodi Gaonthan</option>
  ...
  </optgroup><optgroup label='Bhawani Peth'><option value='39'>Prabhag 39: KEM Hospital</option>
  ...
  </optgroup><optgroup label='Bibvewadi'><option value='64'>Prabhag 64: Salisbury Park</option>
  ...
  </optgroup><optgroup label='Dhankawadi'><option value='69'>Prabhag 69: Dhankawadi Padmavati</option>
  ...
  </optgroup><optgroup label='Dhole Patil Road'><option value='20'>Prabhag 20: Magarpatta City</option>
  ...
  </optgroup><optgroup label='Ghole Road'><option value='11'>Prabhag 11: Janwadi-Gokhalenagar</option>
  ...
  </optgroup><optgroup label='Hadapsar'><option value='42'>Prabhag 42: Lohiya Garden, Vaiduwadi</option>
  ...
  </optgroup><optgroup label='Kasba Vishrambagwada'><option value='37'>Prabhag 37: Shaniwarwada</option>
  ...
  </optgroup><optgroup label='Kondhwa Wanavdi'><option value='41'>Prabhag 41: Sopan Baug - Vikasnagar</option>
  ...
  </optgroup><optgroup label='Kothrud'><option value='26'>Prabhag 26: MIT - Kelewadi</option>
  ...
  </optgroup><optgroup label='Nagar Road'><option value='2'>Prabhag 2: Kharadi Infotech Park</option>
  ...
  </optgroup><optgroup label='Sahakarnagar'><option value='57'>Prabhag 57: Kadakmal Ali Hirabaug</option>
  ...
  </optgroup><optgroup label='Tilak Road'><option value='52'>Prabhag 52: Vaikunth Smashanbhoomi</option>
  ...
  </optgroup><optgroup label='Warje Karvenagar'><option value='30'>Prabhag 30: Popularnagar Malwadi</option>
  ...
  </optgroup><optgroup label='Yerawda - Sangamwadi'><option value='1'>Prabhag 1: Lohegaon Airport</option>
...
<div id="prabhag_no_info" style="text-align: center; font:Times New Roman; font-size: 20; "><b></b></div>
      ...
      </div>           <!-- end of txthint  div -->
</div>                 <!-- end of info col-sm-6  div -->
    <div class="col-sm-6" style="height: 350px;">
      <div id="map" style="height:350px; width:498px; position: relative;"></div>
     </div>            <!-- end of map col-sm-6 div -->
</div>                 <!-- end of my-container div -->

<!-- <div id="space-between-container1-and container2-margin" style="margin-top: 20px;"></div> -->
